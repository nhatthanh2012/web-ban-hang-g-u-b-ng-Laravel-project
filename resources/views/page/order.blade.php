		...
		<div id="content">			
			<form action="{{ route('postCheckout') }}" method="post" class="beta-form-checkout">                
				...
				@if(Session::has('information'))
					<div class="alert alert-success"><b>{{Session::get('information')}} </b></div>				 	
				 @endif 
				</div>
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-block">
							...
							<input type="text" id="name" name='name' placeholder="Họ tên" value="{{ old('name') }}"  required>
						</div>
						...
						<div class="form-block">
							...
							<input type="email" id="email" name='email' value="{{ old('email') }}"  required placeholder="expample@gmail.com">
						</div>

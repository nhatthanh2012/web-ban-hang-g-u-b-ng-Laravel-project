                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        ...
                                        @endif
                                        <a href="{{ route('page.productDetail', $new->id) }}"><img
                                                src="source/image/product/{{ $new->image}}" height='250' alt=""></a>
                                    </div>
                                    ...
                                    <div class="single-item-caption">
                                        ...
                                        <a class="beta-btn primary"
                                            href="{{ route('page.productDetail', $new->id) }}">Chi tiết <i
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        ...
                                        <a href="{{ route('page.productDetail', $promotion->id) }}"><img
                                                src="source/image/product/{{$promotion->image}}" height=250 alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$promotion->name}}</p>
                                        <p class="single-item-text"> Số lượt xem: {{ $promotion->view }}</p>
                                        <p class="single-item-price">
                                            <span class="flash-del">{{ number_format($promotion->unit_price) }}
                                                VND</span>
                                            <span class="flash-sale">{{ number_format($promotion->promotion_price) }}
                                                VND</span>
                                        </p>
                                    </div>
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="{{ route('addCart', $promotion->id)}}"><i
                                                class="fa fa-shopping-cart"></i></a>
                                        <a class="beta-btn primary"
                                            href="{{ route('page.productDetail', $promotion->id) }}">Chi tiết <i
                                                class="fa fa-chevron-right"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
